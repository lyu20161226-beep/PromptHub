  ...
  return (
    <article className="flex h-full flex-col rounded-lg border border-zinc-200 bg-white p-5 shadow-sm transition hover:border-emerald-400 hover:shadow-md sm:p-6">
      ...
      <div className="mt-auto flex items-end justify-between gap-4 pt-6">
        ...
        <Link className="inline-flex min-h-10 items-center justify-center gap-2 rounded-md bg-zinc-950 px-4 text-sm font-semibold text-white hover:bg-emerald-700" href={`/packs#${pack.slug}`}>查看内容 <ArrowRight className="h-4 w-4" aria-hidden="true" /></Link>
      </div>
    </article>
  );
}
